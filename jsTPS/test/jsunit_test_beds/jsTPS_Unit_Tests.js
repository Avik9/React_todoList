...
class jsTPS_Unit_Tests {
    ...
    testAdd() {
        ...
        let tps = new jsTPS();
        let num = new Num();
        document.getElementById("input").innerHTML += "Creating a new Num object...";
        document.getElementById("input").innerHTML += " <br> ";
        document.getElementById("input").innerHTML += "Checking if the num object is equal to 0: "

        if(num.getNum() === 0)
        {
            document.getElementById("input").innerHTML += "Condition Passed"
        }
        else{
            document.getElementById("input").innerHTML += "Condition Failed"
        }
